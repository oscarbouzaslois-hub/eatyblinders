...
const CAT = {
  ...
  hierba: {
    label: "Hierbas y especias",
    color: "#5E8C3A",
    soft: "#ECF3E2"
  },
  condimento: {
    label: "Despensa salada",
    color: "#5F7385",
    soft: "#E9EEF2"
  },
  dulce: {
    label: "Despensa dulce",
    color: "#C0619F",
    soft: "#F8E8F2"
  }
};
...
// ---- VERDURAS Y HORTALIZAS ----
{
  ...
  cb: 9,
  g: 0.1,
  f: ["cruda en ensalada", "pochada", "en salsa (triturada)", "caramelizada", "en aros rebozada"]
}, {
  id: "cebolleta",
  n: "Cebolleta",
  c: "verdura",
  img: "spring-onions.jpg",
  e: "🥬",
  kcal: 32,
  p: 1.8,
  cb: 7,
  ...
  cb: 33,
  g: 0.5,
  f: ["crudo (alioli, gazpacho)", "dorado en aceite", "asado", "en polvo"]
}, {
  id: "tomate",
  n: "Tomate",
  c: "verdura",
  ...
  cb: 3.9,
  g: 0.2,
  f: ["crudo en ensalada", "triturado en salsa", "frito", "asado", "seco"]
}, {
  id: "tomate_cherry",
  n: "Tomate cherry",
  c: "verdura",
  img: "cherry-tomatoes.png",
  e: "🍅",
  kcal: 18,
  p: 0.9,
  cb: 3.9,
  ...
  cb: 6,
  g: 0.3,
  f: ["crudo", "asado", "frito", "en salsa"]
}, {
  id: "pimiento_verde",
  n: "Pimiento verde",
  c: "verdura",
  img: "green-bell-pepper.jpg",
  e: "🫑",
  kcal: 20,
  p: 0.9,
  cb: 4.6,
  g: 0.2,
  f: ["crudo", "frito", "en sofrito"]
}, {
  id: "calabacin",
  n: "Calabacín",
  c: "verdura",
  ...
  cb: 3.1,
  g: 0.3,
  f: ["en crema", "a la plancha", "salteado", "relleno"]
}, {
  id: "berenjena",
  n: "Berenjena",
  c: "verdura",
  ...
  cb: 6,
  g: 0.2,
  f: ["a la plancha", "frita", "rellena", "en pisto"]
}, {
  id: "zanahoria",
  n: "Zanahoria",
  c: "verdura",
  img: "sliced-carrot.png",
  e: "🥕",
  kcal: 41,
  p: 0.9,
  cb: 10,
  g: 0.2,
  f: ["cruda", "rallada en ensalada", "cocida en guiso", "en crema"]
}, {
  id: "patata",
  n: "Patata",
  c: "verdura",
  img: "potatoes-yukon-gold.png",
  e: "🥔",
  kcal: 77,
  p: 2,
  cb: 17,
  g: 0.1,
  f: ["frita", "cocida", "asada", "en puré", "en tortilla"]
}, {
  id: "boniato",
  n: "Boniato",
  c: "verdura",
  img: "sweet-potato.png",
  e: "🍠",
  kcal: 86,
  p: 1.6,
  cb: 20,
  ...
  cb: 7,
  g: 0.4,
  f: ["al vapor", "salteado", "asado al horno", "en crema"]
}, {
  id: "coliflor",
  n: "Coliflor",
  c: "verdura",
  ...
  cb: 5,
  g: 0.3,
  f: ["cocida", "asada", "rebozada", "en crema"]
}, {
  id: "espinacas",
  n: "Espinacas",
  c: "verdura",
  ...
  cb: 3.6,
  g: 0.4,
  f: ["crudas en ensalada", "salteadas", "en crema", "en batido verde"]
}, {
  id: "acelgas",
  n: "Acelgas",
  c: "verdura",
  ...
  n: "Rúcula",
  c: "verdura",
  img: "arugula-or-rocket-salad.jpg",
  e: "🌿",
  kcal: 25,
  p: 2.6,
  cb: 3.7,
  ...
  cb: 3.6,
  g: 0.1,
  f: ["crudo en ensalada", "en gazpacho", "encurtido"]
}, {
  id: "apio",
  n: "Apio",
  c: "verdura",
  ...
  cb: 3.3,
  g: 0.3,
  f: ["crudo laminado", "salteado", "a la plancha", "relleno"]
}, {
  id: "seta",
  n: "Setas variadas",
  c: "verdura",
  img: "mixed-mushrooms.jpg",
  e: "🍄",
  kcal: 25,
  p: 3,
  cb: 4,
  ...
  cb: 10,
  g: 0.2,
  f: ["cocida en ensalada", "en crema fría", "cruda rallada"]
}, {
  id: "kale",
  n: "Col kale",
  c: "verdura",
...
// ---- FRUTAS ----
{
  ...
  cb: 14,
  g: 0.2,
  f: ["cruda", "asada", "en compota", "en bizcocho"]
}, {
  id: "platano",
  n: "Plátano",
  c: "fruta",
  ...
  cb: 9,
  g: 15,
  f: ["en tosta", "en guacamole", "en ensalada"]
}, {
  id: "datil",
  n: "Dátil",
  c: "fruta",
...
// ---- CARNES ----
{
  ...
  n: "Pechuga de pollo",
  c: "carne",
  img: "chicken-breasts.png",
  e: "🍗",
  kcal: 165,
  p: 31,
  cb: 0,
  g: 3.6,
  f: ["a la plancha", "empanada", "al horno", "en guiso", "en curry"]
}, {
  id: "pollo_muslo",
  n: "Muslo de pollo",
  c: "carne",
  img: "chicken-thighs.png",
  e: "🍗",
  kcal: 209,
  p: 26,
  cb: 0,
  ...
  cb: 0,
  g: 9,
  f: ["poco hecho", "al punto", "muy hecho", "en tiras salteado"]
}, {
  id: "carne_picada",
  n: "Carne picada de ternera",
  c: "carne",
  img: "fresh-ground-beef.jpg",
  e: "🥩",
  kcal: 250,
  p: 26,
  cb: 0,
  ...
  n: "Carne picada mixta",
  c: "carne",
  img: "meatloaf-mix.jpg",
  e: "🥩",
  kcal: 263,
  p: 25,
  cb: 0,
  ...
  id: "salchichas",
  n: "Salchichas frescas",
  c: "carne",
  img: "raw-sausages.jpg",
  e: "🌭",
  kcal: 301,
  p: 12,
  cb: 2,
  ...
  n: "Morcilla",
  c: "carne",
  img: "blood-sausage.jpg",
  e: "🌭",
  kcal: 379,
  p: 15,
  cb: 1,
  g: 35,
  f: ["a la plancha", "en guiso de legumbres", "de arroz"]
},
// ---- PESCADOS Y MARISCOS ----
{
  id: "salmon",
  ...
  cb: 0,
  g: 13,
  f: ["a la plancha", "al horno", "crudo (poke, sushi)", "ahumado"]
}, {
  id: "merluza",
  n: "Merluza",
  c: "pescado",
  ...
  cb: 0,
  g: 5,
  f: ["a la plancha (poco hecho)", "en tartar", "muy hecho"]
}, {
  id: "atun_lata",
  n: "Atún en conserva",
  c: "pescado",
  ...
  cb: 0,
  g: 11,
  f: ["a la plancha o espeto", "en lata", "en escabeche"]
}, {
  id: "boqueron",
  n: "Boquerón",
  c: "pescado",
  img: "anchovies-fresh.jpg",
  e: "🐟",
  kcal: 131,
  p: 20,
  cb: 0,
  ...
  cb: 0.2,
  g: 0.3,
  f: ["a la plancha", "al ajillo", "cocida", "en arroz o pasta"]
}, {
  id: "langostino",
  n: "Langostino",
  c: "pescado",
  ...
  cb: 3,
  g: 1.4,
  f: ["a la romana (frito)", "a la plancha", "en su tinta", "en arroz"]
}, {
  id: "pulpo",
  n: "Pulpo",
  c: "pescado",
...
// ---- HUEVOS Y LÁCTEOS ----
{
  ...
  cb: 1.1,
  g: 11,
  f: ["frito", "cocido", "revuelto", "en tortilla", "escalfado (poché)"]
}, {
  id: "leche",
  n: "Leche",
  c: "lacteo",
  ...
  cb: 2.3,
  g: 29,
  f: ["en salsa", "en ensalada", "tal cual"]
}, {
  id: "queso_cabra",
  n: "Queso de cabra",
  c: "lacteo",
  ...
  cb: 0.1,
  g: 30,
  f: ["en ensalada templada", "a la plancha", "tal cual"]
}, {
  id: "requeson",
  n: "Requesón",
  c: "lacteo",
...
// ---- LEGUMBRES ----
{
  ...
  cb: 27,
  g: 2.6,
  f: ["en guiso o cocido", "en hummus", "en ensalada", "tostados crujientes"]
}, {
  id: "lentejas",
  n: "Lentejas",
  c: "legumbre",
  ...
  cb: 1.9,
  g: 4.8,
  f: ["a la plancha marinado", "en curry o salteado", "en crema/postres"]
}, {
  id: "guisante_seco",
  n: "Guisante seco",
  c: "legumbre",
...
// ---- CEREALES, PASTA Y PAN ----
{
  ...
  id: "noodles",
  n: "Noodles orientales",
  c: "cereal",
  img: "asian-noodles.jpg",
  e: "🍜",
  kcal: 138,
  p: 4.5,
  cb: 25,
...
// ---- HIERBAS Y ESPECIAS ----
{
  ...
  cb: 3.7,
  g: 0.5,
  f: ["fresco por encima", "cocinado en el plato"]
}, {
  id: "albahaca",
  n: "Albahaca",
  c: "hierba",
  ...
  cb: 18,
  g: 0.8,
  f: ["fresco rallado", "en infusión", "encurtido", "en polvo"]
}, {
  id: "canela",
  n: "Canela",
  c: "hierba",
...
// ---- DESPENSA SALADA ----
{
  ...
  n: "Mostaza",
  c: "condimento",
  img: "dijon-mustard.jpg",
  e: "🟡",
  kcal: 66,
  p: 4,
  cb: 6,
  g: 3.3,
  f: ["suave (en salsas)", "fuerte tipo Dijon", "en grano"]
}, {
  id: "mayonesa",
  n: "Mayonesa",
  c: "condimento",
  ...
  id: "tomate_frito",
  n: "Tomate frito / salsa de tomate",
  c: "condimento",
  ...
  cb: 5,
  g: 0.9,
  f: ["en salsas", "por encima en ensaladas"]
}, {
  id: "aceitunas",
  n: "Aceitunas",
  c: "condimento",
  img: "olives-mixed.jpg",
  e: "🫒",
  kcal: 115,
  p: 0.8,
  cb: 6,
  g: 11,
  f: ["verdes", "negras", "rellenas de anchoa"]
}, {
  id: "pepinillos",
  n: "Pepinillos",
  c: "condimento",
  ...
  cb: 2.3,
  g: 0.2,
  f: ["en vinagre tal cual", "picados en salsas"]
}, {
  id: "tahini",
  n: "Tahini",
  c: "condimento",
  img: "tahini-paste.png",
  e: "🥜",
  kcal: 595,
  p: 17,
  cb: 21,
...
// ---- DESPENSA DULCE ----
{
  ...
  id: "chocolate_leche",
  n: "Chocolate con leche",
  c: "dulce",
  img: "milk-chocolate.jpg",
  e: "🍫",
  kcal: 535,
  p: 8,
  cb: 59,
  ...
  n: "Leche condensada",
  c: "dulce",
  img: "sweetened-condensed-milk.jpg",
  e: "🥛",
  kcal: 321,
  p: 8,
  cb: 54,
...
const RECETAS = [{
  ...
  pasos: [{
    ...
    t: "Confítalas en abundante aceite a fuego medio-bajo hasta que estén tiernas, sin que se doren demasiado.",
    s: 1200
  }, {
    t: "Escurre bien el aceite. Bate los huevos en un bol grande con una pizca de sal."
  }, {
    t: "Mezcla patata y cebolla con el huevo y deja reposar para que se empapen.",
    s: 300
  }, {
    t: "Cuaja en sartén antiadherente a fuego medio, 3 min por el primer lado.",
    s: 180
  }, {
  ...
  tags: ["vegana", "sin lactosa", "frío", "verano"],
  ing: [{
    id: "tomate",
    q: "1 kg",
    forma: "crudo en ensalada"
  }, {
    id: "pepino",
    q: "1/2 ud",
    forma: "en gazpacho"
  ...
  pasos: [{
    ...
    t: "Tritura todo junto con el vinagre y la sal hasta que quede muy fino.",
    s: 120
  }, {
    ...
    t: "Enfría en la nevera al menos 1 hora antes de servir.",
    s: 3600
  }]
}, {
  id: "salmorejo",
  ...
  tags: ["frío", "verano", "clásico español"],
  ing: [{
    id: "tomate",
    q: "1 kg",
    forma: "crudo en ensalada"
  ...
  pasos: [{
    ...
    t: "Añade el pan troceado y deja que se empape 10 minutos.",
    s: 600
  }, {
    t: "Tritura con ajo y sal; añade el aceite en hilo hasta que quede cremoso.",
    s: 120
  }, {
    t: "Cuece los huevos 10 min, enfría y pícalos.",
    s: 600
  }, {
  ...
  tags: ["alta en fibra", "de cuchara", "batch cooking", "congelable"],
  ing: [{
    id: "lentejas",
    q: "320 g"
  }, {
  ...
  pasos: [{
    t: "Sofríe cebolla, ajo, pimiento y zanahoria picados en el aceite.",
    s: 480
  }, {
    t: "Añade el pimentón, remueve 30 segundos y agrega el tomate triturado.",
    s: 120
  }, {
    t: "Incorpora lentejas, patata en trozos, laurel y agua que cubra dos dedos."
  }, {
    t: "Cuece a fuego suave hasta que la lenteja esté tierna. Remueve de vez en cuando.",
    s: 1800
  }, {
  ...
  tags: ["vegetariana", "ligera", "apta para niños", "congelable"],
  ing: [{
    id: "calabacin",
    q: "2 uds",
    forma: "en crema"
  ...
  pasos: [{
    t: "Pocha la cebolla en el aceite hasta que esté transparente.",
    s: 300
  }, {
    t: "Añade calabacín y patata troceados y rehoga 5 minutos.",
    s: 300
  }, {
    t: "Cubre con el caldo y cuece hasta que la patata esté tierna.",
    s: 900
  }, {
  ...
  pasos: [{
    ...
    t: "Dora los ajos en el aceite y resérvalos antes de que se quemen.",
    s: 120
  }, {
    t: "En ese aceite, dora el pollo bien por todos los lados.",
    s: 600
  }, {
    t: "Devuelve los ajos, añade vino, laurel y romero, y deja evaporar el alcohol.",
    s: 120
  }, {
  ...
  pasos: [{
    ...
    t: "Añade el doble de agua que de arroz y sal; cuece tapado a fuego bajo.",
    s: 1080
  }, {
  ...
  pasos: [{
    t: "Cuece la pasta en agua con sal siguiendo el tiempo del paquete.",
    s: 540
  }, {
    t: "Mientras, dora el bacon en tiras a fuego medio sin aceite.",
    s: 300
  }, {
  ...
  pasos: [{
    t: "Sofríe cebolla, ajo, zanahoria y apio picados muy finos.",
    s: 480
  }, {
    t: "Sube el fuego, añade la carne y dórala deshaciéndola bien.",
    s: 360
  }, {
    t: "Agrega tomate y orégano; cocina a fuego suave al menos 20 min.",
    s: 1200
  }, {
    t: "Cuece los macarrones en agua con sal y escúrrelos al dente.",
    s: 600
  }, {
  ...
  pasos: [{
    ...
    t: "Corta el pan en dados y tuéstalos con un hilo de aceite hasta dorarse.",
    s: 300
  }, {
    t: "Marca la pechuga salpimentada a la plancha, 3-4 min por lado, y córtala en tiras.",
    s: 420
  }, {
  ...
  id: "salmon_horno",
  n: "Salmón al horno con verduras",
  cat: "cena",
  dif: 1,
  min: 30,
  rac: 2,
  ...
  pasos: [{
    ...
    t: "Extiéndelas en una bandeja, aliña con aceite, sal y pimienta, y hornea 12 min.",
    s: 720
  }, {
    t: "Coloca encima los lomos salpimentados, con rodajas de limón y eneldo."
  }, {
    t: "Hornea 10-12 min más, hasta que el salmón esté jugoso pero hecho.",
    s: 660
  }, {
  ...
  tags: ["sin lactosa", "clásico español"],
  ing: [{
    id: "merluza",
    q: "4 lomos"
  }, {
  ...
  pasos: [{
    t: "Dora el ajo picado en el aceite sin que tome color.",
    s: 90
  }, {
    t: "Añade la harina, remueve, y agrega vino y caldo poco a poco sin dejar de mover.",
    s: 180
  }, {
    t: "Incorpora la merluza salada y las almejas; menea la cazuela para ligar.",
    s: 300
  }, {
    t: "Cocina a fuego suave hasta que las almejas se abran y la merluza esté hecha.",
    s: 360
  }, {
  ...
  id: "albondigas",
  n: "Albóndigas en salsa de tomate",
  cat: "comida",
  dif: 2,
  min: 50,
  rac: 4,
  ...
  pasos: [{
    ...
    t: "Forma bolas, pásalas por harina y dóralas en aceite. Resérvalas.",
    s: 480
  }, {
    t: "En ese aceite, pocha la cebolla y añade el tomate; cocina 10 min.",
    s: 600
  }, {
    t: "Tritura la salsa, devuelve las albóndigas y cuece a fuego suave.",
    s: 900
  }, {
  ...
  tags: ["vegetariana", "sin gluten", "de aprovechamiento"],
  ing: [{
    id: "tomate",
    q: "600 g",
    forma: "triturado en salsa"
  }, {
    id: "calabacin",
    q: "1 ud",
    forma: "salteado"
  ...
  pasos: [{
    ...
    t: "Pocha la cebolla y los pimientos a fuego medio-bajo.",
    s: 600
  }, {
    t: "Añade berenjena y calabacín y cocina hasta que estén tiernos.",
    s: 600
  }, {
    t: "Agrega el tomate con una pizca de azúcar y sal; reduce a fuego lento.",
    s: 900
  }, {
  ...
  pasos: [{
    ...
    t: "Saltea el pollo a fuego fuerte hasta dorarlo y resérvalo.",
    s: 360
  }, {
    t: "Saltea las verduras en la misma sartén hasta que estén al dente.",
    s: 300
  }, {
    t: "Junta todo, exprime la lima por encima y da un último golpe de calor.",
    s: 120
  }, {
  ...
  tags: ["vegana", "sin gluten", "especiada"],
  ing: [{
    id: "garbanzos",
    q: "400 g (cocidos)",
    forma: "en guiso o cocido"
  }, {
    id: "cebolla",
    q: "1 ud",
    forma: "pochada"
  ...
  pasos: [{
    t: "Pocha la cebolla; añade ajo y jengibre rallados y el curry, y tuesta 1 min.",
    s: 420
  }, {
    t: "Agrega el tomate y cocina hasta que pierda el agua.",
    s: 300
  }, {
    t: "Incorpora garbanzos y leche de coco; cuece a fuego suave.",
    s: 600
  }, {
    t: "Mientras, cuece el arroz basmati (2 partes de agua por 1 de arroz).",
    s: 720
  }, {
  ...
  tags: ["vegetariana", "italiana", "para impresionar"],
  ing: [{
    id: "arroz_redondo",
    q: "320 g"
  }, {
  ...
  pasos: [{
    t: "Saltea las setas a fuego fuerte y resérvalas. Mantén el caldo caliente.",
    s: 300
  }, {
    t: "Pocha la cebolla picada fina; añade el arroz y nácaralo 2 min.",
    s: 420
  }, {
    t: "Moja con el vino y deja evaporar sin dejar de remover.",
    s: 120
  }, {
    t: "Añade caldo caliente cazo a cazo, removiendo, durante unos 18 min.",
    s: 1080
  }, {
    t: "Incorpora las setas al final de la cocción."
  }, {
    t: "Fuera del fuego, manteca con mantequilla y parmesano. Reposa 2 min y sirve.",
    s: 120
  }]
}, {
  id: "ensaladilla",
  ...
  tags: ["fría", "clásico español", "para compartir"],
  ing: [{
    id: "patata",
    q: "800 g",
    forma: "cocida"
    ...
    id: "pepinillos",
    q: "4 uds",
    forma: "picados en salsas"
  }, {
    id: "aceitunas",
    q: "un puñado",
    forma: "rellenas de anchoa"
  }, {
    id: "sal",
    q: "al gusto"
  }],
  pasos: [{
    t: "Cuece las patatas y zanahorias con piel en agua con sal hasta que estén tiernas.",
    s: 1500
  }, {
    t: "Cuece los huevos 10 min y los guisantes 5. Enfría todo.",
    s: 600
  }, {
    ...
    t: "Enfría 30 min y decora con aceitunas antes de servir.",
    s: 1800
  }]
}, {
  id: "hummus",
  ...
  tags: ["vegana", "sin gluten", "para picar"],
  ing: [{
    id: "garbanzos",
    q: "400 g (cocidos)",
    forma: "en hummus"
  ...
  pasos: [{
    ...
    t: "Tritura garbanzos, tahini, zumo de limón, ajo, comino y sal.",
    s: 120
  }, {
  ...
  tags: ["vegana", "sin gluten", "tex-mex"],
  ing: [{
    id: "aguacate",
    q: "3 uds",
    forma: "en guacamole"
  ...
  tags: ["vegetariana", "brunch", "rápida"],
  ing: [{
    id: "pan_integral",
    q: "2 rebanadas"
  }, {
  ...
  pasos: [{
    t: "Tuesta el pan hasta que esté crujiente.",
    s: 180
  }, {
    t: "Machaca el aguacate con limón y sal, y úntalo generosamente."
  }, {
    t: "Escalfa el huevo 3 min en agua con un chorrito de vinagre.",
    s: 180
  }, {
  ...
  tags: ["vegetariana", "saciante", "energía lenta"],
  ing: [{
    id: "avena",
    q: "50 g"
  }, {
  ...
  pasos: [{
    t: "Cuece la avena con la leche a fuego suave removiendo.",
    s: 300
  }, {
  ...
  tags: ["sin lactosa", "fresca", "de moda"],
  ing: [{
    id: "arroz_redondo",
    q: "180 g"
  }, {
  ...
  pasos: [{
    ...
    t: "Marina el salmón con soja y la cebolleta picada en la nevera.",
    s: 900
  }, {
    t: "Cuece el arroz, aliña con un toque de vinagre y deja templar.",
    s: 1080
  }, {
  ...
  tags: ["rápida", "asiática", "de aprovechamiento"],
  ing: [{
    id: "pollo_pechuga",
    q: "300 g",
    forma: "a la plancha"
  ...
  pasos: [{
    t: "Cuece los noodles según el paquete, escurre y reserva.",
    s: 240
  }, {
    t: "Saltea el pollo en tiras a fuego muy fuerte y resérvalo.",
    s: 240
  }, {
    t: "Saltea las verduras en bastones con ajo y jengibre, que queden crujientes.",
    s: 240
  }, {
    t: "Devuelve el pollo, añade noodles y soja, y saltea todo junto 1 min.",
    s: 60
  }, {
  ...
  tags: ["sin gluten", "baja en carbohidratos", "rápida"],
  ing: [{
    id: "huevo",
    q: "4 uds",
    forma: "revuelto"
  ...
  pasos: [{
    t: "Saltea las setas a fuego fuerte hasta que doren.",
    s: 240
  }, {
    t: "Añade ajo picado y las gambas; cocina 2 min.",
    s: 120
  }, {
  ...
  tags: ["vegetariana", "italiana", "plan con niños"],
  ing: [{
    id: "harina",
    q: "300 g"
  }, {
  ...
  pasos: [{
    t: "Amasa harina, 190 ml de agua tibia, levadura, sal y 1 cda de aceite hasta que quede lisa.",
    s: 600
  }, {
    t: "Deja fermentar tapada en sitio cálido hasta que doble.",
    s: 3600
  }, {
    ...
    t: "Hornea 8 min, añade la mozzarella y hornea 4-5 min más.",
    s: 780
  }, {
  ...
  tags: ["vegetariana", "apta para niños", "merienda"],
  ing: [{
    id: "yogur",
    q: "1 ud (y su vaso de medida)"
  }, {
    id: "huevo",
    q: "3 uds"
  }, {
  ...
  pasos: [{
    t: "Precalienta el horno a 180 °C. Bate huevos y azúcar hasta que espumen.",
    s: 180
  }, {
    ...
    t: "Vierte en molde engrasado y hornea 35-40 min sin abrir el horno.",
    s: 2220
  }, {
  ...
  tags: ["vegetariana", "sin gluten", "de la abuela"],
  ing: [{
    id: "arroz_redondo",
    q: "100 g"
  }, {
    ...
    id: "canela",
    q: "1 rama + para espolvorear"
  }, {
    id: "limon",
    q: "piel de 1"
  }],
  pasos: [{
    t: "Infusiona la leche con la canela y la piel de limón hasta que hierva.",
    s: 300
  }, {
    t: "Añade el arroz y cuece a fuego muy suave removiendo a menudo.",
    s: 2100
  }, {
    t: "Cuando esté cremoso, agrega el azúcar y cocina 5 min más.",
    s: 300
  }, {
  ...
  tags: ["vegetariana", "merienda", "plan con niños"],
  ing: [{
    id: "harina",
    q: "125 g"
  }, {
  ...
  pasos: [{
    ...
    t: "Deja reposar la masa en la nevera.",
    s: 900
  }, {
    t: "Calienta una sartén antiadherente engrasada; vierte un cacito y extiende girando."
  }, {
    t: "Cocina 1 min, voltea y 30 s más. Repite con toda la masa.",
    s: 90
  }, {
  ...
  tags: ["ligera", "reconfortante", "apta para niños"],
  ing: [{
    id: "caldo_pollo",
    q: "1,2 l"
  }, {
  ...
  pasos: [{
    t: "Lleva el caldo a ebullición con la zanahoria y el apio en daditos.",
    s: 600
  }, {
    t: "Añade el pollo en tiras finas y cuece 5 min.",
    s: 300
  }, {
    t: "Incorpora los fideos y cuece el tiempo del paquete.",
    s: 300
  }, {
    t: "Rectifica de sal y sirve con perejil picado."
  }]
}, {
  id: "espinacas_garbanzos",
  ...
  tags: ["vegana", "de cuchara", "clásico español"],
  ing: [{
    id: "espinacas",
    q: "400 g",
    forma: "salteadas"
  ...
  pasos: [{
    t: "Fríe el pan y los ajos en el aceite y májalos con comino y vinagre.",
    s: 240
  }, {
    t: "Saltea las espinacas en la misma sartén hasta que reduzcan.",
    s: 180
  }, {
    t: "Añade garbanzos, el majado y el pimentón; mezcla bien."
  }, {
    t: "Cocina 5 min con un chorrito de agua para que se integre todo.",
    s: 300
  }]
}, {
  id: "berenjenas_rellenas",
  n: "Berenjenas rellenas de carne",
  cat: "comida",
  dif: 2,
  min: 55,
  rac: 4,
  ...
  tags: ["sin gluten", "horno", "apta para niños"],
  ing: [{
    id: "berenjena",
    q: "2 uds",
    forma: "rellena"
  ...
  pasos: [{
    t: "Corta las berenjenas a lo largo, haz cortes en la carne y hornéalas a 200 °C.",
    s: 1500
  }, {
    t: "Vacíalas con cuidado y pica la pulpa. Reserva las barcas."
  }, {
    t: "Sofríe la cebolla, añade la carne y dórala; agrega pulpa, tomate y orégano.",
    s: 600
  }, {
  ...
  tags: ["rápida", "alta en proteína", "asiática"],
  ing: [{
    id: "ternera_filete",
    q: "300 g",
    forma: "en tiras salteado"
  }, {
    id: "pimiento_rojo",
    q: "1 ud",
    forma: "crudo"
  ...
  pasos: [{
    t: "Corta la ternera en tiras finas y séllala a fuego muy fuerte. Reserva.",
    s: 180
  }, {
    t: "Saltea cebolla y pimiento en tiras hasta que estén al dente.",
    s: 240
  }, {
    t: "Devuelve la carne, añade ajo y soja, y saltea 1 min más.",
    s: 60
  }, {
...
function parseQty(q) {
  ...
  if (unit === "cdtas") unit = "cdta";
  if (unit === "latas") unit = "lata";
  if (unit === "rebanadas") unit = "rebanada";
  if (unit === "dientes") unit = "diente";
  if (unit === "lomos") unit = "lomo";
  if (unit === "hojas") unit = "hoja";
  if (unit === "vasos") unit = "vaso";
  if (unit === "filetes") unit = "filete";
  return {
    num,
    unit
  };
...
function agregarCompra(items) {
  ...
  for (const it of items) {
    if (!porIng[it.ingId]) porIng[it.ingId] = {
      sums: {},
      libres: [],
      recetas: new Set()
    };
    ...
    if (p) e.sums[p.unit] = (e.sums[p.unit] || 0) + p.num;else if (it.q) e.libres.push(it.q);
  }
  const out = [];
  ...
  out.sort((a, b) => {
    const ca = ING_MAP[a.ingId]?.c || "z",
      cb2 = ING_MAP[b.ingId]?.c || "z";
...
function calcLogros(st) {
  ...
  return [{
    id: "cata10",
    n: "Primeras catas",
    d: "Valora 10 ingredientes",
    ok: nVal >= 10,
    icon: "🍽️"
  }, {
    id: "cata50",
    n: "Explorador de mercado",
    d: "Valora 50 ingredientes",
    ok: nVal >= 50,
    icon: "🧭"
  }, {
    id: "cata120",
    n: "Paladar enciclopédico",
    d: "Valora 120 ingredientes",
    ok: nVal >= 120,
    icon: "📚"
  }, {
    id: "abierto",
    n: "Paladar abierto",
    d: "Al menos 40 ingredientes que te gustan",
    ok: nLike >= 40,
    icon: "🌈"
  }, {
    id: "matiz",
    n: "Maestro del matiz",
    d: "Personaliza formas en 5 ingredientes",
    ok: nMatiz >= 5,
    icon: "🎛️"
  }, {
    id: "prueba1",
    n: "¡Estreno!",
    d: "Marca tu primera receta como probada",
    ok: probadas >= 1,
    icon: "⭐"
  }, {
    id: "prueba5",
    ...
    id: "valiente",
    n: "Sin miedo al fuego",
    d: "Prueba una receta elaborada",
    ok: dif3,
    icon: "🔥"
  }, {
    id: "planif",
    n: "Semana resuelta",
    d: "Llena 8 huecos del planificador",
    ok: slots >= 8,
    icon: "🗓️"
  }];
}
...
const T = {
  ...
  bad: "#D8455B",
  radius: 20,
  shadow: "0 8px 24px rgba(36,31,46,0.08)"
};
const GLOBAL_CSS = `
...
function IngImg({
  ...
  return /*#__PURE__*/_jsx("div", {
    style: {
      ...
      flexShrink: 0,
      overflow: "hidden",
      background: `linear-gradient(145deg, ${cat.soft}, #fff)`,
      border: `1.5px solid ${cat.color}22`,
      display: "flex",
      alignItems: "center",
      justifyContent: "center"
...
function BtnPrimario({
  ...
  return /*#__PURE__*/_jsx("button", {
    ...
    disabled: disabled,
    style: {
      background: disabled ? "#D8D4CC" : T.brand,
      color: "#fff",
      fontWeight: 700,
      fontSize: 15,
      borderRadius: 16,
      ...
      justifyContent: "center",
      gap: 8,
      boxShadow: disabled ? "none" : "0 6px 16px rgba(232,83,44,0.35)",
      ...style
    },
    children: children
  });
...
function orderDeck(prefs) {
  ...
  return pendientes.map((i, idx) => ({
    i,
    k: (idx + seed) * 2654435761 % 233280
...
function Descubrir({
  ...
  const onUp = () => {
    if (drag && Math.abs(drag.x) > 90) decidir(drag.x > 0);else setDrag(null);
    start.current = null;
  };
  const dx = drag?.x || 0;
      ...
      children: [/*#__PURE__*/_jsxs("div", {
        ...
        children: [/*#__PURE__*/_jsx("button", {
          ...
          style: {
            ...
            borderRadius: "50%",
            background: T.ok,
            boxShadow: "0 8px 20px rgba(31,157,99,0.4)",
            display: "flex",
            alignItems: "center",
            justifyContent: "center"
          },
    ...
    children: [/*#__PURE__*/_jsx("p", {
      ...
      children: ing.f.map(f => /*#__PURE__*/_jsxs("button", {
        ...
        style: {
          ...
          padding: "12px 14px",
          borderRadius: 14,
          background: sel[f] ? "#E4F5EC" : "#F6F3EE",
          border: `1.5px solid ${sel[f] ? T.ok : T.line}`,
          fontSize: 14.5,
          fontWeight: 600,
...
function TileReceta({
  ...
  return /*#__PURE__*/_jsx("div", {
    ...
    style: {
      ...
      borderRadius: 18,
      flexShrink: 0,
      background: "linear-gradient(150deg, #FCEAE3, #FFF6EE 70%)",
      border: "1.5px solid #F2D9CD",
      display: "flex",
      alignItems: "center",
      justifyContent: "center"
    },
    children: /*#__PURE__*/_jsx("div", {
      style: {
        ...
        borderRadius: "50%",
        background: "#fff",
        boxShadow: "0 3px 10px rgba(232,83,44,0.22)",
        display: "flex",
        alignItems: "center",
        justifyContent: "center",
        fontSize: size * 0.38
...
function badgeMatch(score) {
  if (score === null) return {
    txt: "Cata ingredientes para ver tu match",
    bg: "#F1EEE8",
    col: T.sub
  };
  if (score >= 80) return {
...
function Recetas({
  ...
  const lista = useMemo(() => {
    let l = RECETAS.map(r => ({
      r,
      m: matchReceta(r, st.prefs)
    }));
    if (q.trim()) {
      const t = q.trim().toLowerCase();
      l = l.filter(({
        r
      }) => r.n.toLowerCase().includes(t) || r.tags.some(x => x.includes(t)));
    }
    if (fDif) l = l.filter(({
      r
    }) => r.dif === fDif);
    if (fTiempo) l = l.filter(({
      r
    }) => r.min <= fTiempo);
    if (fCat !== "todas") l = l.filter(({
      r
    }) => r.cat === fCat);
  ...
  const selChip = act => ({
    ...
    color: act ? "#fff" : T.sub,
    border: `1.5px solid ${act ? T.ink : T.line}`,
    borderRadius: 999,
    padding: "7px 13px",
    fontSize: 13,
    fontWeight: 600,
          ...
          children: [/*#__PURE__*/_jsx("h2", {
            ...
            children: [1, 2, 4].map(n => /*#__PURE__*/_jsx("button", {
              ...
              style: {
                ...
                fontWeight: 700,
                fontSize: 14,
                background: porciones === n ? T.brandSoft : "#fff",
                color: porciones === n ? T.brand : "#A29D93",
...
function Plan({
  ...
  const [q, setQ] = useState("");
  const setSlot = (key, recId) => setSt(s => ({
    ...s,
    plan: {
      ...s.plan,
      [key]: recId
  ...
  return /*#__PURE__*/_jsxs("div", {
    ...
    children: [/*#__PURE__*/_jsxs("div", {
      ...
      children: [/*#__PURE__*/_jsxs("div", {
        ...
        children: candidatas.slice(0, 30).map(({
          r,
          m
        }) => {
          const b = badgeMatch(m.score);
...
function Compra({
  ...
  const addExtra = () => {
    ...
    setSt(s => ({
      ...
      compra: {
        ...s.compra,
        extras: [...s.compra.extras, t]
      }
    }));
    setNuevo("");
  };
  const quitarExtra = i => setSt(s => ({
    ...s,
    compra: {
      ...s.compra,
      extras: s.compra.extras.filter((_, x) => x !== i)
    }
  }));
            ...
            return /*#__PURE__*/_jsxs("button", {
              ...
              children: [/*#__PURE__*/_jsx("span", {
                style: {
                  ...
                  height: 22,
                  borderRadius: 8,
                  border: `2px solid ${done ? T.ok : "#CFCABF"}`,
                  background: done ? T.ok : "#fff",
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
                  flexShrink: 0
    ...
    children: [/*#__PURE__*/_jsx("h1", {
      ...
      children: [/*#__PURE__*/_jsx("h2", {
        ...
        children: logros.map(l => /*#__PURE__*/_jsxs("div", {
          style: {
            ...
            borderRadius: 16,
            border: `1.5px solid ${l.ok ? "#EED9B8" : T.line}`,
            padding: "11px 12px",
            opacity: l.ok ? 1 : 0.65
          },
          children: [/*#__PURE__*/_jsx("div", {
      ...
      children: [/*#__PURE__*/_jsx("h2", {
        ...
        children: [/*#__PURE__*/_jsxs("div", {
          ...
          className: "yt-scroll",
          children: valorados.map((i, idx) => {
            const s = ingStatus(prefs[i.id]);
            const lbl = {
              me_gusta: ["Te gusta", "#14603D", "#E4F5EC"],
...
export default function App() {
  ...
  const addCompra = r => {
    setSt(s => ({
      ...
      compra: {
        ...s.compra,
        items: [...s.compra.items, ...r.ing.filter(it => !BASICOS.has(it.id)).map(it => ({
          ingId: it.id,
          q: it.q,
          recetaId: r.id
        }))]
  ...
  const addSemanaCompra = () => {
    ...
    setSt(s => {
      ...
      for (const id of Object.values(s.plan)) {
        ...
        if (r) items.push(...r.ing.filter(it => !BASICOS.has(it.id)).map(it => ({
          ingId: it.id,
          q: it.q,
          recetaId: r.id
        })));
  ...
  const sorprender = () => {
    const cands = RECETAS.map(r => ({
      r,
      m: matchReceta(r, st.prefs)
    })).filter(({
      r,
      m
    }) => !st.probadas[r.id] && (m.score === null || m.score >= 40));
    const pool = cands.length ? cands : RECETAS.map(r => ({
      r,
      m: matchReceta(r, st.prefs)
    }));
            ...
            children: [/*#__PURE__*/_jsx("span", {
              ...
              return /*#__PURE__*/_jsxs("button", {
                ...
                style: {
                  ...
                  fontSize: 13,
                  fontWeight: 700,
                  background: ocupado ? "#F1EEE8" : T.brandSoft,
                  color: ocupado ? T.sub : T.brand,
